...
import se.agreedskiing.hibernate.timezone.quarkus.two.reactive.profiles.JdbcTimezone;

@QuarkusTest
@TestProfile(value = JdbcTimezone.class)
class UTCConversionWithJdbcTimezoneTest {
